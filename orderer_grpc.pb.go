...
type OrdererServiceClient interface {
	Order(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[OrderRequest, OrderResponse], error)
}
...
func (c *ordererServiceClient) Order(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[OrderRequest, OrderResponse], error) {
...
type OrdererService_OrderClient = grpc.BidiStreamingClient[OrderRequest, OrderResponse]
...
type OrdererServiceServer interface {
	Order(grpc.BidiStreamingServer[OrderRequest, OrderResponse]) error
...
func (UnimplementedOrdererServiceServer) Order(grpc.BidiStreamingServer[OrderRequest, OrderResponse]) error {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type OrdererService_OrderServer = grpc.BidiStreamingServer[OrderRequest, OrderResponse]
